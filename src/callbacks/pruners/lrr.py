...
class LearningRateRewinding(ABCMagnitudePruner):
    ...
    def on_train_start(self, trainer: pl.Trainer, pl_module: pl.LightningModule):
        ...
        logging.info("Learning Rate Rewinding reset steps:")
    ...
    def on_train_batch_start(self, trainer: pl.Trainer, pl_module: pl.LightningModule, batch, batch_idx):
        ...
        if current_step in self.reset_step_targets.keys():
            logging.info(f"Resetting weights at step {current_step} for Learning Rate Rewinding")
